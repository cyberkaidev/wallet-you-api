...
import { BalanceService, BalanceServiceProps } from "../interfaces/balance-service.interface";

export async function balanceService({ publicKey }: BalanceServiceProps): Promise<BalanceService> {
  const client = tatum();
